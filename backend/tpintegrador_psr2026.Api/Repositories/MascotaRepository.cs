...
public class MascotaRepository : IMascotaRepository
{
    ...
    public List<Mascota> ObtenerTodos() => _elementos;

    public Mascota? ObtenerPorId(int id) => _elementos.FirstOrDefault(e => e.Id == id);
    ...
    public bool Actualizar(int id, Mascota entidad)
    {
